...
<html lang="en">
    ...
    <body>
                ...
                <input id="notelp" type="text" class="form-control @error('notelp') is-invalid @enderror" name="notelp" value="{{ old('notelp') }}" required autocomplete="notelp" placeholder="Phone Number">
            </div>
            
            <button type="submit" class="btn mt-3 text-uppercase btn-custom btn-block rounded-pill button-lg">Register</button>
